...
@objc public protocol BMPlayerControlViewDelegate: class {
    ...
    @objc optional func controlView(controlView: BMPlayerControlView, didChangeMute mute: Bool)
}
...
open class BMPlayerControlView: UIView {
    ...
    open func autoFadeOutControlViewWithAnimation() {
        ...
        delayItem?.notify(queue: DispatchQueue.main, execute: {
            print("Notify delay item")
        })
