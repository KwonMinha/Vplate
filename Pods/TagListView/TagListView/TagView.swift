...
open class TagView: UIButton {
    ...
    open var removeButton = CloseButton()
    ...
    private func updateRightInsets() {
        if enableRemoveButton {
            titleEdgeInsets.left = removeButtonIconSize + paddingX 
        }
        else {
            titleEdgeInsets.left = paddingX
        }
    ...
    open override func layoutSubviews() {
        ...
        if enableRemoveButton {
            ...
            removeButton.frame.origin.x = 0//self.frame.width - removeButton.frame.width
