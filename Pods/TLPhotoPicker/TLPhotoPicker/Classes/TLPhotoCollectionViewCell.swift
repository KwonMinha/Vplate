...
open class TLPhotoCollectionViewCell: UICollectionViewCell {
    ...
    @IBOutlet weak var minimumDurationView: UIView?
    ...
    open var duration: TimeInterval? {
        didSet {
            ...
            self.minimumDurationView?.isHidden = (duration >= self.configure.minimumDuration)
            self.isUserInteractionEnabled = (duration >= self.configure.minimumDuration)
        }
    }
...
//        print("deinit TLPhotoCollectionViewCell")
    ...
    override open func awakeFromNib() {
        ...
        self.minimumDurationView?.isHidden = true
        self.videoIconImageView?.image = self.configure.videoIcon
    }
