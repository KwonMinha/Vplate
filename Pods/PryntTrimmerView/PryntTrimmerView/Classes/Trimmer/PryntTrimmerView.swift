...
@IBDesignable public class TrimmerView: AVAssetTimeSelector {
    ...
    private let leftHandleKnob = UILabel()
    private let rightHandleKnob = UILabel()
    ...
    private func setupHandleView() {
        ...
        leftHandleKnob.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.7).isActive = true
        ...
        rightHandleKnob.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.7).isActive = true
        ...
        leftHandleKnob.text = "<"
        rightHandleKnob.text = ">"
        leftHandleKnob.textAlignment = .center
        rightHandleKnob.textAlignment = .center
    }
    ...
    private func updateHandleColor() {
        leftHandleKnob.textColor = handleColor
        rightHandleKnob.textColor = handleColor
    }
