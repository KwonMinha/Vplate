...
class IsoCountries {
    ...
    class var allCountries:Array<IsoCountryInfo> {
        ...
        get {
            return [
                IsoCountryInfo(name: "", numeric: "0", alpha2: "", alpha3: "", calling: "", currency: "", continent: "" ),
                IsoCountryInfo(name: "Afghanistan", numeric: "4", alpha2: "AF", alpha3: "AFG", calling: "+93", currency: "AFN", continent: "AS" ),
                IsoCountryInfo(name: "Åland Islands", numeric: "248", alpha2: "AX", alpha3: "ALA", calling: "+358", currency: "FIM", continent: "EU" ),
                IsoCountryInfo(name: "Albania", numeric: "8", alpha2: "AL", alpha3: "ALB", calling: "+355", currency: "ALL", continent: "EU" ),
                IsoCountryInfo(name: "Algeria", numeric: "12", alpha2: "DZ", alpha3: "DZA", calling: "+213", currency: "DZD", continent: "AF" ),
                IsoCountryInfo(name: "American Samoa", numeric: "16", alpha2: "AS", alpha3: "ASM", calling: "+684", currency: "USD", continent: "OC" ),
                IsoCountryInfo(name: "Andorra", numeric: "20", alpha2: "AD", alpha3: "AND", calling: "+376", currency: "EUR", continent: "EU" ),
                IsoCountryInfo(name: "Angola", numeric: "24", alpha2: "AO", alpha3: "AGO", calling: "+244", currency: "AOA", continent: "AF" ),
                IsoCountryInfo(name: "Anguilla", numeric: "660", alpha2: "AI", alpha3: "AIA", calling: "+264", currency: "XCD", continent: "NA" ),
                IsoCountryInfo(name: "Antarctica", numeric: "10", alpha2: "AQ", alpha3: "ATA", calling: "+672", currency: "AUD", continent: "AN" ),
                IsoCountryInfo(name: "Antigua and Barbuda", numeric: "28", alpha2: "AG", alpha3: "ATG", calling: "+268", currency: "XCD", continent: "NA" ),
                IsoCountryInfo(name: "Argentina", numeric: "32", alpha2: "AR", alpha3: "ARG", calling: "+54", currency: "ARS", continent: "SA" ),
                IsoCountryInfo(name: "Armenia", numeric: "51", alpha2: "AM", alpha3: "ARM", calling: "+374", currency: "AMD", continent: "AS" ),
                IsoCountryInfo(name: "Aruba", numeric: "533", alpha2: "AW", alpha3: "ABW", calling: "+297", currency: "AWG", continent: "NA" ),
                IsoCountryInfo(name: "Australia", numeric: "36", alpha2: "AU", alpha3: "AUS", calling: "+61", currency: "AUD", continent: "OC" ),
                IsoCountryInfo(name: "Austria", numeric: "40", alpha2: "AT", alpha3: "AUT", calling: "+43", currency: "EUR", continent: "EU" ),
                IsoCountryInfo(name: "Azerbaijan", numeric: "31", alpha2: "AZ", alpha3: "AZE", calling: "+994", currency: "AZN", continent: "AS" ),
                IsoCountryInfo(name: "Bahamas", numeric: "44", alpha2: "BS", alpha3: "BHS", calling: "+242", currency: "BSD", continent: "NA" ),
                IsoCountryInfo(name: "Bahrain", numeric: "48", alpha2: "BH", alpha3: "BHR", calling: "+973", currency: "BHD", continent: "AS" ),
                IsoCountryInfo(name: "Bangladesh", numeric: "50", alpha2: "BD", alpha3: "BGD", calling: "+880", currency: "BDT", continent: "AS" ),
                IsoCountryInfo(name: "Barbados", numeric: "52", alpha2: "BB", alpha3: "BRB", calling: "+246", currency: "BBD", continent: "NA" ),
                IsoCountryInfo(name: "Belarus", numeric: "112", alpha2: "BY", alpha3: "BLR", calling: "+375", currency: "BYR", continent: "EU" ),
                IsoCountryInfo(name: "Belgium", numeric: "56", alpha2: "BE", alpha3: "BEL", calling: "+32", currency: "EUR", continent: "EU" ),
                IsoCountryInfo(name: "Belize", numeric: "84", alpha2: "BZ", alpha3: "BLZ", calling: "+501", currency: "BZD", continent: "NA" ),
                IsoCountryInfo(name: "Benin", numeric: "204", alpha2: "BJ", alpha3: "BEN", calling: "+229", currency: "XOF", continent: "AF" ),
                IsoCountryInfo(name: "Bermuda", numeric: "60", alpha2: "BM", alpha3: "BMU", calling: "+441", currency: "BMD", continent: "NA" ),
                IsoCountryInfo(name: "Bhutan", numeric: "64", alpha2: "BT", alpha3: "BTN", calling: "+975", currency: "BTN", continent: "AS" ),
                IsoCountryInfo(name: "Bolivia, Plurinational State of", numeric: "68", alpha2: "BO", alpha3: "BOL", calling: "+591", currency: "BOB", continent: "SA" ),
                IsoCountryInfo(name: "Bonaire, Sint Eustatius and Saba", numeric: "535", alpha2: "BQ", alpha3: "BES", calling: "+599", currency: "USD", continent: "" ),
                IsoCountryInfo(name: "Bosnia and Herzegovina", numeric: "70", alpha2: "BA", alpha3: "BIH", calling: "+387", currency: "BAM", continent: "EU" ),
                IsoCountryInfo(name: "Botswana", numeric: "72", alpha2: "BW", alpha3: "BWA", calling: "+267", currency: "BWP", continent: "AF" ),
                IsoCountryInfo(name: "Bouvet Island", numeric: "74", alpha2: "BV", alpha3: "BVT", calling: "+47", currency: "NOK", continent: "AN" ),
                IsoCountryInfo(name: "Brazil", numeric: "76", alpha2: "BR", alpha3: "BRA", calling: "+55", currency: "BRL", continent: "SA" ),
                IsoCountryInfo(name: "British Indian Ocean Territory", numeric: "86", alpha2: "IO", alpha3: "IOT", calling: "+246", currency: "USD", continent: "AS" ),
                IsoCountryInfo(name: "Brunei Darussalam", numeric: "96", alpha2: "BN", alpha3: "BRN", calling: "+673", currency: "BND", continent: "AS" ),
